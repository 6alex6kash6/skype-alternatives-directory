...
export const gotoReviews: Review[] = [
  {
    id: 1,
    author: "Addison Z.",
  ...
  },
  {
    ...
    rating: 3,
    date: "2025-04-16",
    title: "I've used GoTo for the past year and they've been fine to deal with un...",
  ...
  },
  {
    ...
    date: "2025-05-06",
    title: "Awful rip off.",
    content: "Awful rip off. They make it impossible to get pre vetted. Adding new requirements each time to add to terms and conditions on the website. And they deny you and then bill you. Each time!  Awful",
    helpful: 58,
    notHelpful: 2
  },
  {
  ...
  },
  {
    ...
    rating: 4,
    date: "2025-04-12",
    title: "I can't speak to the quality of the product, however, the customer ser...",
  ...
  },
  {
    ...
    date: "2025-04-11",
    title: "BEWARE!",
    content: "BEWARE! You will not receive notification of upcoming subscription renewal. They will not refund the renewal amount even if contacting them the day after your renewal for UNUSED SERVICES! Sketchy business practices.",
    helpful: 64,
    notHelpful: 10
  },
  {
    ...
    rating: 3,
    date: "2025-05-11",
    title: "Terrible customer service, if even possible to go trough their AI who know nothing.",
    content: "Terrible customer service, if even possible to go trough their AI who know nothing. ",
    helpful: 59,
    notHelpful: 8
  },
  {
    ...
    rating: 3,
    date: "2025-04-30",
    title: "I was a customer for six years but decided to make a change due to rep...",
    content: "I was a customer for six years but decided to make a change due to repeated poor customer service in the last few years. I reached out to cancel my service in 2024 days before time but received no contact until after I was charged. Then upon \"terms of the agreement' nothing was done. No contact was made between us for another year until my card was charged a second time with no prior communication. This, again after the fact they have assured me they have canceled the account, and now it's in writing. However, again per \"terms of the agreement\" no prorated refund. ",
    helpful: 54,
    notHelpful: 8
  },
  {
  ...
  },
  {
    ...
    rating: 3,
    date: "2025-03-27",
    title: "Constant reloading. ...",
    content: "Constant reloading. Calls not going through.",
    helpful: 33,
    notHelpful: 6
  },
  {
    ...
    rating: 3,
    date: "2025-03-13",
    title: "I was told there would only be a charge per user and that my office ph...",
    content: "I was told there would only be a charge per user and that my office phones devices would not be charged to activate as shared devices.  My surprise our first bill was over 6 times larger than the price quoted and I was then told that the 3 phones, 2 ATAs and both users incurred the charges.  To remove the devices would get us down to the quoted price.  Looking to port my numbers out as soon as possible.  A competitor has offered activation for all devices at the original rate that GoTo quoted.  GoTo Customer service was absolutely terrible and did not offer to fix the problem.   ",
    helpful: 68,
    notHelpful: 8
  },
  {
    ...
    rating: 3,
    date: "2025-04-02",
    title: "It is not currently ...",
    content: "It is not currently letting me log in.",
    helpful: 66,
    notHelpful: 4
  },
  {
    ...
    rating: 3,
    date: "2025-05-05",
    title: "I was given the most patient person, he did not make me feel rushed or...",
    content: "I was given the most patient person, he did not make me feel rushed or not important and solved all my needs in re - doing my company after hours recorded message.",
    helpful: 29,
    notHelpful: 6
  },
  {
    ...
    rating: 3,
    date: "2025-03-17",
    title: "The whole transition...",
    content: "The whole transition was so incredible and quick.",
    helpful: 39,
    notHelpful: 3
  },
  {
    ...
    rating: 3,
    date: "2025-04-23",
    title: "I had asked multiple times to cancel my subscription and there's never...",
    content: "I had asked multiple times to cancel my subscription and there's never a reply. I even removed my credit card information off the platform and still getting billed. Support sucks and the platform is not user friendly at all.",
    helpful: 69,
    notHelpful: 4
  },
  {
    ...
    rating: 3,
    date: "2025-04-28",
    title: "former logmein hamachi.",
    content: "Impossible to contact support or you get automated rejection request.\nImpossible to delete your account. Shame on this company",
    helpful: 96,
    notHelpful: 7
  },
  {
    ...
    rating: 3,
    date: "2025-03-15",
    title: "Things have really gone down hill since Jive was acquired by GoTo.",
    content: "Things have really gone down hill since Jive was acquired by GoTo. Contacting support is a chore. You no longer have the option to email. \n\nEdit to add: \nThe URL provided in the reply from GoTo does not allow you to email support. It allows you to fill out a form and then directs you to call support. ",
    helpful: 60,
    notHelpful: 1
  },
  {
    ...
    rating: 3,
    date: "2025-04-18",
    title: "CAUTION:\n Unauthorized GOTO monthly charges to my credit after cancell...",
