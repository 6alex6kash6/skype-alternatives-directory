    ...
    <footer className="bg-gray-100 pt-12 pb-8 mt-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-lg font-semibold mb-4 text-gray-800">SkypeAlternatives</h3>
            <p className="text-gray-600 mb-4">Find and compare the best alternatives to Skype with honest user reviews and ratings.</p>
          </div>
